...
open class SearchTextField: UITextField {
    ...
    open var highlightAttributes: [NSAttributedString.Key: AnyObject] = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 10)]
    ...
    override open func willMove(toSuperview newSuperview: UIView?) {
        ...
        self.addTarget(self, action: #selector(SearchTextField.textFieldDidChange), for: UIControl.Event.editingChanged)
        self.addTarget(self, action: #selector(SearchTextField.textFieldDidBeginEditing), for: UIControl.Event.editingDidBegin)
        self.addTarget(self, action: #selector(SearchTextField.textFieldDidEndEditing), for: UIControl.Event.editingDidEnd)
        self.addTarget(self, action: #selector(SearchTextField.textFieldDidEndEditingOnExit), for: UIControl.Event.editingDidEndOnExit)
